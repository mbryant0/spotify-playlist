...
function Circle(_a) {
    ...
    return (jsx_runtime_1.jsx("div", __assign({ className: classnames_1.default(style_module_css_1.default['lds-circle'], className), style: __assign({ background: color, width: size, height: size }, style) }, rest), void 0));
}
